...
const Funding = ({ sectionIndex }) => {
  return (
    <PageTransition sectionIndex={sectionIndex} currentSectionIndex={4}>
      <StyledSection>
        <header>
          <StyledSectionTitle>
          ...
          <StyledSectionDiscription>
            ...
            dolorem ullam asperiores repudiandae, adipisci fugiat, amet
            cupiditate repellendus nesciunt ipsa? Hic ipsa odit minus fugit
            repudiandae blanditiis quam! Tempore sequi eum enim dolore
            consectetur?
          </StyledSectionDiscription>
        </header>
        <StyledGridContainer>
